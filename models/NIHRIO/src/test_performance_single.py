...
def test_performance(training_directory, filename):
    ...
    print("Final mlp F1: %0.4f (+/- %0.4f)" %
          (mlp_f1_scores.mean(), mlp_f1_scores.std() * 2))
...
if __name__ == "__main__":
    ...
    test_performance(
        training_directory,
        "SemEval2018-T3-train-taskA_emoji_1-gram_frequency_non_ironic_20.txt"
    )
